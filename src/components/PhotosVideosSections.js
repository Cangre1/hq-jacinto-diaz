...
const PhotosVideosSection = () => {
  ...
  return (
    <section
      id="detalles"
      className="py-12 xl:py-24 bg-gray-100 overflow-hidden"
    >
      <div className="space-y-14">
        <div className="container mx-auto px-4 xl:w-1/2 2xl:w-1/3 mx-auto">
          <h2 className="text-2xl xl:text-4xl font-light text-center mb-4">
            Cuidamos cada detalle
          </h2>
          <p className="text-sm xl:text-lg text-gray-600 text-center">
            Nuestros procesos aseguran que cada detalle esté a la vista, desde
            la compra del terreno hasta la entrega final.{" "}
          </p>
        </div>
